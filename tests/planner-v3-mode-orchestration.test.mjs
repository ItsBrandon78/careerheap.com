...
test('dashboard component includes required control actions and stale warning text', () => {
  ...
  assert.match(dashboardSource, /2\. 14-Day Action Card/)
  assert.match(dashboardSource, /3\. Best Route Card/)
  assert.match(dashboardSource, /11\. Longer-Term Roadmap Card/)
  ...
  assert.match(dashboardSource, /9\. Adjacent Entry Options/)
